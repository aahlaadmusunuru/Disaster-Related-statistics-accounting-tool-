...
In this section, users will be able to see the population, land cover, points of interest, and infrastructure layers affected  maps.
Additionally, users can also access the statistical table.Morever withe the Meta data information.
