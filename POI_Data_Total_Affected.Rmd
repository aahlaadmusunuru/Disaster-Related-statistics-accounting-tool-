...
---
title: Point of Interest Affected Statistic report.|
...
# Introduction
In this report the users will be able to see the point of interest layer on the map displays below. The table shows the different Statistics information.

## Point of Interest-map

The point of interest  map below offers comprehensive insights into a variety of essential places.
...
The table below shows the total count of the Point of Interest data it provides detail information of the different types of locations exposed to hazard. 
