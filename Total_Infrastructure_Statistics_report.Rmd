...
---
title: Total Infrastructure Statistic report.|
...
# Introduction
In this report the users will be able to see the Infrastructure layer the map displays below. The table shows the different Statistics information.

## Infrastructure Indicators-map

The interactive map below offers comprehensive insights into a variety of essential Infrastructure Indicators, providing a detailed and informative perspective on the infrastructure landscape.
...
```
*Figure 1: Shows the Infrastructure map.* 

## Infrastructure Statistic Information Table:

The table below shows the total length of the Infrastructure data it provides detail information of the different types of Information and the Length.Km. 
